            ...
            <section className="auth-form-section">
                <form className="auth-form" onSubmit={submitForm}>
                    <span className="auth-input-wraper">
                        ...
                        <input onChange={onhendelchenge} value={user.email} className="auth-inputs" type="email" name="email" placeholder="Your login or e-mail" required/>
                    </span>
                    <span className="auth-input-wraper">
                        ...
                        <input onChange={onhendelchenge} value={user.password} className="auth-inputs" type={ispasswordvisible ? "text" : "password"} name="password" placeholder="Password" required/>
